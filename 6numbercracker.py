...
def options():
    ...
    if option == "2":
        print("")
        os.system("hashcat -m 13000 -a 3 'hash.txt' ?d?d?d?d?d?d > password.txt")
        while True:
            options()

    if option == "3":
        print("")
        os.system("crunch 6 6 0123456789 -o wordlist.txt")
    ...
    if option == "4":
        print("")
        os.system("clear")
        print("The password is in the hash, there are the numbers behind the two points (:XXXXXX)")
        time.sleep(5)
